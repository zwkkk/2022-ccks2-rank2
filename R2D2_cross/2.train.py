...
from dataset import get_model_data, R2D2PairDataset, r2d2_pair_collate_fn, R2D2CrossDataset, r2d2_cross_collate_fn
...
def run():
    ...
    train_dataset = R2D2CrossDataset(train_texts1, train_texts2, train_img_paths_1, train_img_paths_2, train_labels, max_length=200)
    test_dataset = R2D2CrossDataset(test_texts1, test_texts2, test_img_paths_1, test_img_paths_2, test_labels, max_length=200)
    model = R2D2FullCrossForAlign("pretrain_checkpoints/last/pytorch_model.bin")
    print(model)
