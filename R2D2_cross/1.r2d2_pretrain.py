...
from dataset import get_pretrain_data, R2D2SingleDataset, r2d2_single_collate_fn, get_pretrain_data_v4, r2d2_pair_pretrain_collate_fn
...
def run_pair_pretrain():
    texts, img_paths = get_pretrain_data_v4()
