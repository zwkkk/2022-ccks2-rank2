...
def run_for_full_cross():
    results = []
    item_id1, item_id2, texts1, texts2, img_paths_1, img_paths_2 = get_model_data_v2("valid", return_ids=True)
    ...
    with open("./outputs/bqw_result.jsonl", "w", encoding="utf-8") as file:
