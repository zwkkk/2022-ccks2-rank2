...
def run_for_distill_cross():
    ...
    embeddings1 = encoder.encode(texts1, img_paths_1, return_numpy=True, batch_size=6)
    embeddings2 = encoder.encode(texts2, img_paths_2, return_numpy=True, batch_size=6)
